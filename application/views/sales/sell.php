                    ...
                    <tbody>
                        ...
                        <?php foreach ($cartItems as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url('sell/cancel_item/' . $item->id) ?>" type="button"
                    ...
                    <?php foreach ($products as $product): ?>
                        <tr>
                            ...
                            <?php if ($product->inventory != 0): ?>
                                <td><a href="sell/create_cart/<?= $product->id ?>/<?= $product->retail_price ?>"
                                        class="border border-green-300 p-1">
                                        <?= number_format($product->retail_price) ?>
                                    </a></td>
                                <td><a href="sell/create_cart/<?= $product->id ?>/<?= $product->whole_price ?>"
                                        class="border border-green-300 p-1">
                                        <?= number_format($product->whole_price) ?>
                                    </a></td>
                            <?php else: ?>
                                <td><a href="javascript:void" class="border border-green-300 p-1" href="google.com">
                                        <?= number_format($product->retail_price) ?>
                                    </a></td>
                                <td><a href="javascript:void" class="border border-green-300 p-1" href="afyasoft.vercel.app">
                                        <?= number_format($product->whole_price) ?>
                                    </a></td>
                            <?php endif ?>
                        </tr>
