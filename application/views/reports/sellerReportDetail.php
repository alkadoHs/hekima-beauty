...
<main class="p-4  md:ml-64 h-auto pt-20 ">
        ...
        <div>
            ...
            <?php else: ?>
                <p class="text-slate-400 my-2">Date: <span class="text-orange-500">
                        ...
                        href="<?= site_url('sellersReport/sellerReportDetail/' . $user->id) ?>">Today</a> </p>
            <?php endif ?>
        </div>
        <form action="<?php echo base_url('sellersReport/filter_seller_dashboard') ?>" date-rangepicker
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <div class="rounded-lg shadow-lg p-4 bg-pink-200 dark:border-gray-600 h-32 md:h-36">
            <p class="text-slate-400 text-xl">Expenses </p>
            <p class="text-xl text-orange-500"> <a class="hover:underline active:underline" href="#expenses">
        ...
        <div
            ...
            <div>
                ...
                <p class="text-xl font-semibold text-green-500">
                    <?= format_price($totalProfit - $totalExpenses) ?>
                </p>
            </div>
        </div>
    </div>
                ...
                <?php foreach ($orders as $order): ?>
                    <h2 id="<?= $order['id'] ?>">
                        <button type="button"
                            ...
                            <span>Customer: <b class="text-orange-500">
                                    <?= $order['customerId'] ?>
                                </b></span>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($order['orderItems'] as $order_detail): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= format_price($order_detail['profit']) ?>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
