  ...
  <main class="py-4 md:ml-64 h-auto pt-20 ">
    <?php if($this->session->flashdata('pay_credit_order_success')): ?>
        ...
        <?php endif; ?>
        <h3 class="text-2xl font-bold text-center text-gray-500">Order History</h3>
                ...
                <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                    <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
                        ...
                        <div class="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
                            <a href="<?= site_url('purchaseOrder/index') ?>" class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:ring-sky-300 dark:bg-sky-600 dark:hover:bg-sky-700 focus:outline-none dark:focus:ring-sky-800">
