            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div
                        ...
                        <button id="addStaffModalButton" data-modal-toggle="addStaffModal" type="button"
                                ...
                                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                    ...
                                    <div>
                                        ...
                                        <?php if ($this->session->flashdata('register_failed')): ?>
                                            <p>
                                                <?= $this->session->flashdata('register_failed') ?>
                                            </p>
                                        <?php endif; ?>
                                    </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">ROLE(POSITION)</th>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <a href="<?= site_url("user/edit/" . $user->id) ?>"
                                            class="py-2 px-3 flex items-center text-sm font-medium text-center text-white bg-sky-700 rounded-lg hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300 dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800">
